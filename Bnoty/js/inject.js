...
!(function (window_t, func_e) {
  ...
  e_group = {
    ...
    startPainting: function (event) {
      ...
      if (event.which === 1) {
        ...
        if (this.activate == "fill") {
          this.handleFill(event.offsetX, event.offsetY);
        }
    ...
    onMouseMove: function (event) {
      ...
      if (!this.painting) {
        ...
        if (this.activate == "pen") {
          ...
          this.ctx.bezierCurveTo(this.sX, c - o, h - s, this.sY, h, this.sY);
    ...
    onMouseClick: function (event) {
      ...
      if (this.activate == "text") {
        ...
        if (!this.hasInput) {
          ...
          e_group.pageY =
            event.offsetY - Math.floor(e_group.size.replace("px", "") / 2);
        }
      }
    },
    addInput: function (x, y) {
      ...
      input.style.top =
        y - Math.floor(e_group.size.replace("px", "") / 2) + "px";
      ...
      for (var o = 0; o < this.drawOptions.length; o++) {
        ...
        if (!window_e.document.getElementById("penBox")) {
          ...
          tmp_pen.addEventListener("click", function () {
            ...
            e_group.ctx.strokeStyle = e_group.strokeStyle;
          });
